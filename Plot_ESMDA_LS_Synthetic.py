...
or one well (ie one time series)
"""
...
if mode == "Pastas":
    modelpath = os.path.abspath("models//synthetic//na8ne250")
...
with open(os.path.abspath(
        "models//synthetic//na" + str(na) + "ne" + str(ne) + "//" +
...
modelpath = os.path.abspath("models//synthetic//na" + str(na) + "ne" + str(ne))
