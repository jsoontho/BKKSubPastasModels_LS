...
for mod_i in range(len(besttry_Pastasmodels)):
    ...
    rmse_data = truth[1].merge(
        model_plotls[mod_i].simulate(),
        left_on=truth[1].index, right_on=model_plotls[mod_i].simulate().index,
        how="inner")
...
bar_colors = ['red', 'fuchsia', 'blue', 'cyan']
bar_labels = ["Initial", "Ordinary Least Squares", "Regularized Least Squares", "Truth"]
